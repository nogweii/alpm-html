...
def main(argv):
  ...
  group.add_argument('-d', '--pkg-dir', metavar = '<dir>', action = 'store',
                    dest = 'pkg_dir', type = str, default = '.',
  ...
  group.add_argument('--css', metavar = '<file>', action = 'store',
                    dest = 'css', type = str, default = 'archrepo.css',
                    help = 'What CSS file to include in the build')
  group.add_argument('--url', metavar = '<url>', action = 'store',
                    dest = 'repo_url', type = str,
